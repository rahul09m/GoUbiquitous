...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter{// implements
    ...
    private void notifyWearable() {
       /*if (mGoogleApiClient == null || !mGoogleApiClient.isConnected()) {
        ...
        final String highTemp = Utility.formatTemperature(getContext(), cursor.getDouble(INDEX_MAX_TEMP));
        final String lowTemp = Utility.formatTemperature(getContext(), cursor.getDouble(INDEX_MIN_TEMP));
        ...
        mapRequest.getDataMap().putString(KEY_HIGH, highTemp);
        mapRequest.getDataMap().putString(KEY_LOW, lowTemp);
        mapRequest.getDataMap().putAsset(KEY_ICON, createAssetFromBitmap(iconBitmap));
